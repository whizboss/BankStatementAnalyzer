...
class CommandParser {
  ...
  CommandParser(AnalyzerController analyzerController) {
  ...
  public void executeCommand(List<String> command) {
    ...
    switch (command.get(0).toUpperCase()) {
      case "NUMBER_OF_VIDEOS":
        this.analyzerController.numberOfVideos();
        break;
      case "SHOW_ALL_VIDEOS":
        this.analyzerController.showAllVideos();
        break;
      case "PLAY":
        try {
          this.analyzerController.playVideo(command.get(1));
        } catch (ArrayIndexOutOfBoundsException e) {
          System.out.println("Please enter PLAY command followed by video_id.");
        }
        break;
      case "PLAY_RANDOM":
        this.analyzerController.playRandomVideo();
        break;
      case "STOP":
        this.analyzerController.stopVideo();
        break;
      case "PAUSE":
        this.analyzerController.pauseVideo();
        break;
      case "CONTINUE":
        this.analyzerController.continueVideo();
        break;
      case "SHOW_PLAYING":
        this.analyzerController.showPlaying();
        break;
      case "CREATE_PLAYLIST":
        try {
          this.analyzerController.createPlaylist(command.get(1));
        } catch (ArrayIndexOutOfBoundsException e) {
          System.out.println(
      ...
      case "ADD_TO_PLAYLIST":
        try {
          this.analyzerController.addVideoToPlaylist(command.get(1), command.get(2));
        } catch (ArrayIndexOutOfBoundsException e) {
          System.out.println(
      ...
      case "REMOVE_FROM_PLAYLIST":
        try {
          this.analyzerController.removeFromPlaylist(command.get(1), command.get(2));
        } catch (ArrayIndexOutOfBoundsException e) {
          System.out.println(
      ...
      case "CLEAR_PLAYLIST":
        try {
          this.analyzerController.clearPlaylist(command.get(1));
        } catch (ArrayIndexOutOfBoundsException e) {
          System.out.println(
      ...
      case "DELETE_PLAYLIST":
        try {
          this.analyzerController.deletePlaylist(command.get(1));
        } catch (ArrayIndexOutOfBoundsException e) {
          System.out.println(
      ...
      case "SHOW_PLAYLIST":
        try {
          this.analyzerController.showPlaylist(command.get(1));
        } catch (ArrayIndexOutOfBoundsException e) {
      ...
      case "SHOW_ALL_PLAYLISTS":
        this.analyzerController.showAllPlaylists();
        break;
      case "SEARCH_VIDEOS":
        try {
          this.analyzerController.searchVideos(command.get(1));
        } catch (ArrayIndexOutOfBoundsException e) {
      ...
      case "SEARCH_VIDEOS_WITH_TAG":
        try {
          this.analyzerController.searchVideosWithTag(command.get(1));
        } catch (ArrayIndexOutOfBoundsException e) {
          System.out.println(
      ...
      case "FLAG_VIDEO":
        try {
          this.analyzerController.flagVideo(command.get(1), command.get(2));
        } catch (ArrayIndexOutOfBoundsException e) {
          try {
            this.analyzerController.flagVideo(command.get(1));
      ...
      case "ALLOW_VIDEO":
        try {
          this.analyzerController.allowVideo(command.get(1));
        } catch (ArrayIndexOutOfBoundsException e) {
  ...
  private void getHelp() {
    String helpText =
        "Available commands:\n"
            ...
            + "    ANALYZE <file_path> - Analyzes a specified bank statement file.\n"
